			...
			charts: [
				{
					id: "chart_1",
					chart:
						"/Users/lellyo/Desktop/cool-projects/nyu-hacks/data/Chart1.png",
				},
			],
			stats: [
				{
							...
							return (
								...
								>
									...
									<div className="mt-2 grid grid-cols-2 gap-2 text-xs">
										...
										<p>
											Median Income: $
											{stats.avg_median_income?.toLocaleString()}
										</p>
										<p>
											Bachelors+:{" "}
											{(stats.avg_pct_bachelors_plus * 100).toFixed(1)}%
										</p>
										<p>
											Foreign Born:{" "}
											{(stats.avg_pct_foreign_born * 100).toFixed(1)}%
										</p>
				...
				<div className="mt-8 space-y-6">
					...
					<div className="space-y-4">
						<div className="border rounded-lg overflow-hidden shadow-lg">
							<img
								src="/pptx_images/slide_1.png"
								alt="Generated Slide 1"
								className="w-full"
							/>
						</div>
						<div className="border rounded-lg overflow-hidden shadow-lg">
							<img
								src="/pptx_images/slide_2.png"
								alt="Generated Slide 2"
								className="w-full"
							/>
						</div>
					</div>
